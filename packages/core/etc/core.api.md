## API Report File for "@pesos/core"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import type { Currency as Currency_2 } from '@dinero.js/currencies';
...
dineroObject: Dinero<TAmount>,
newCurrency: Currency_2<TAmount>,
rates: Rates<TAmount>
) => Dinero<TAmount>;
...
calculator: Calculator<TAmount>
): (dineroObject: Dinero<TAmount>) => readonly TAmount[];

// @public (undocumented)
export type ToUnitsParams<TAmount> = readonly [
dineroObject: Dinero<TAmount>
];
